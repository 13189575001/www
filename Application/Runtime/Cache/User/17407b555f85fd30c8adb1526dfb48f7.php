						...
						<div class="am-tabs am-tabs-d2 am-margin" data-am-tabs>
							...
							<div class="am-tabs-bd">
								<div class="am-tab-panel am-fade am-in am-active" id="tab1">
                                   <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><div class="comment-main">
										<div class="comment-list">
											<ul class="item-list">
												...
												<li class="td td-comment">
													...
													<div class="item-info">
														<div>
															<p class="info-little"><span>颜色：<?php echo ($d["color"]); ?></span> <span>尺码：<?php echo ($d["measure"]); ?></span> </p>
															<p class="info-time"><?php echo ($d["date"]); ?></p>
