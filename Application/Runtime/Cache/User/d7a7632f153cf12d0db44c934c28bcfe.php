...
<title>潮流前线</title>
   ...
   <script src="/Fashionmall/Public/User/js/jquery.minjs" ></script>
...
<div id="mains">
    ...
    <div id="jiqiao">
        ...
        <div class="displays" id="dis" >
            ...
            <a href="<?php echo U('Index/skill');?>" style="display: block;margin: auto auto;width: 100px;font-size: 14px;height: 30px;background:#010102;text-align: center;border-radius: 10px;line-height: 30px"><span>点击查看</span></a>
        </div>
