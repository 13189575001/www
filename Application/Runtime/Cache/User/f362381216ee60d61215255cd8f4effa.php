...
<head>
    ...
    <link href="/Fashionmall/Public/User/css/infstyle.css" rel="stylesheet" type="text/css">
        ...
        <div class="main-wrap">
            ...
            <div class="user-safety">
                <div class="am-cf am-padding">
                    <div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">个人账户</strong> / <small>information</small></div>
                </div>
                <hr/>
                ...
                <div class="user-infoPic">
                    ...
                    <div class="filePic">
                        <img class="am-circle am-img-thumbnail" src="/Fashionmall/Public/User/images/getAvatar.do.jpg" alt="" />
                        <div class="editimg">
                    ...
                    <div class="info-m">
                        <div><b>用户名：<i><?php echo session('nickname') ?></i></b>
                            <button class=" layui-btn-primary " id="parentIframe" onclick="c()">
                ...
                <div class="check">
                    <ul>
                        ...
                        <li>
                            ...
                            <div class="fore3">
                                <a href="setpay.html">
                                    <div class="am-btn am-btn-secondary" id="secondary">立即启用</div>
                                </a>
                            </div>
                        </li>
                        <li>
