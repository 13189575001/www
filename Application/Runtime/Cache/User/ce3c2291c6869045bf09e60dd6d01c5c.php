                    ...
                    <div class="J_addressWrap address-wrap">
                        <!--<div class="user-default-address" id="J_userDefaultAddress">-->
                            ...
                            <!--<div class="address-info">-->
                                <!--&lt;!&ndash;<select name="city" lay-verify="">&ndash;&gt;-->
                                    <!--&lt;!&ndash;<option value="">请选择一个地址</option>&ndash;&gt;-->
                                    <!--&lt;!&ndash;<option value="010">北京..........</option>&ndash;&gt;-->
                                    <!--&lt;!&ndash;<option value="021">上海........</option>&ndash;&gt;-->
                                    <!--&lt;!&ndash;<option value="0571">杭州......</option>&ndash;&gt;-->
                                <!--&lt;!&ndash;</select>&ndash;&gt;-->

                            <!--</div>-->
                                <!--&lt;!&ndash;<span class="switch-choose-regions" id="J_switchChooseRegions"> 修改 </span>&ndash;&gt;-->
                            <!--</div>-->
